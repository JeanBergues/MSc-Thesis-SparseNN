    ...
    for d_nlags in dlag_opt:
        for h_nlags in use_hlag:
            ...
            if True:
                ...
                for K in K_opt:
                    ...
                    for i in range(len(mses)):
                        predictor = return_MLP_estimator(Xt, Xv, yt, yv, Xt.shape[1], verbose=0, K=K, activation='tanh', epochs=20_000, patience=100, drop=0)
            ...
            for i in range(n_tests):
                nn = return_MLP_estimator(Xt, Xv, yt, yv, Xt.shape[1], verbose=0, K=best_K, activation='tanh', epochs=20_000, patience=100, drop=0)
